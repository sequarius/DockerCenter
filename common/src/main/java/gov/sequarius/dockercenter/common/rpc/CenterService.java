...
public class CenterService {
  ...
  public interface Iface extends BaseService.Iface {
     ...
     * @param authCode
     */
    public ResultDTO registerNode(NodeInfoDTO nodeInfo, String authCode) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends BaseService .AsyncIface {

    public void registerNode(NodeInfoDTO nodeInfo, String authCode, org.apache.thrift.async.AsyncMethodCallback<ResultDTO> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends BaseService.Client implements Iface {
    ...
    public ResultDTO recv_registerNode() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends BaseService.AsyncClient implements AsyncIface {
    ...
    public static class registerNode_call extends org.apache.thrift.async.TAsyncMethodCall<ResultDTO> {
      private NodeInfoDTO nodeInfo;
      private String authCode;
      public registerNode_call(NodeInfoDTO nodeInfo, String authCode, org.apache.thrift.async.AsyncMethodCallback<ResultDTO> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends BaseService.AsyncProcessor<I> {
    ...
    public static class registerNode<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, registerNode_args, ResultDTO> {
      public registerNode() {
        super("registerNode");
      }
      ...
      public void start(I iface, registerNode_args args, org.apache.thrift.async.AsyncMethodCallback<ResultDTO> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class registerNode_result implements org.apache.thrift.TBase<registerNode_result, registerNode_result._Fields>, java.io.Serializable, Cloneable, Comparable<registerNode_result>   {
    ...
    public registerNode_result setSuccess(ResultDTO success) {
      this.success = success;
      return this;
    }

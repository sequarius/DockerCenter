...
public class NodeInfoDTO implements org.apache.thrift.TBase<NodeInfoDTO, NodeInfoDTO._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfoDTO> {
   ...
   * docker 版本信息
   */
  public String dockerVersion; // required
  /**
   * docker 状态
   */
  public String dockerStatus; // required
  /**
   * 节点tag
   */
   ...
   * ip
   */
  public NodeInfoDTO setIp(String ip) {
    this.ip = ip;
    return this;
  }
   ...
   * 操作系统类型
   */
  public NodeInfoDTO setArchitecture(String architecture) {
    this.architecture = architecture;
    return this;
  }
   ...
   * docker 版本信息
   */
  public NodeInfoDTO setDockerVersion(String dockerVersion) {
    this.dockerVersion = dockerVersion;
    return this;
  }
   ...
   * docker 状态
   */
  public NodeInfoDTO setDockerStatus(String dockerStatus) {
    this.dockerStatus = dockerStatus;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RUNNING_CONTAINER_COUNT:
      if (value == null) {
        ...
        setRunningContainerCount((Long)value);
      }
      break;
  ...
  public int compareTo(NodeInfoDTO other) {
    ...
    lastComparison = Boolean.valueOf(isSetFreeDiskSpace()).compareTo(other.isSetFreeDiskSpace());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetFreeMemorySpace()).compareTo(other.isSetFreeMemorySpace());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetContainerCount()).compareTo(other.isSetContainerCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetRunningContainerCount()).compareTo(other.isSetRunningContainerCount());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDockerVersion()).compareTo(other.isSetDockerVersion());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDockerVersion()) {
    ...
    lastComparison = Boolean.valueOf(isSetDockerStatus()).compareTo(other.isSetDockerStatus());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDockerStatus()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NodeInfoDTO(");
    boolean first = true;

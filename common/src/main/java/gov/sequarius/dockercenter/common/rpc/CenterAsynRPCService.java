...
public class CenterAsynRPCService {
  ...
  public interface AsyncIface {
    ...
    public void onCommandExcuteFinish(ExecuteResultDTO executeResultDTO, org.apache.thrift.async
            .AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
...
;
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("connet_args(");
      boolean first = true;
  ...
  public static class onCommandExcuteFinish_args implements org.apache.thrift.TBase<onCommandExcuteFinish_args, onCommandExcuteFinish_args._Fields>, java.io.Serializable, Cloneable, Comparable<onCommandExcuteFinish_args>   {
    ...
    public int compareTo(onCommandExcuteFinish_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetExecuteResultDTO()).compareTo(other.isSetExecuteResultDTO());
      if (lastComparison != 0) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("onCommandExcuteFinish_args(");
      boolean first = true;

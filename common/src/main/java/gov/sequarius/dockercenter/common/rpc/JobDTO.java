...
public class JobDTO implements org.apache.thrift.TBase<JobDTO, JobDTO._Fields>, java.io.Serializable, Cloneable, Comparable<JobDTO> {
  ...
  public String deployStrategy; // optional
  public String subNameStrategy; // optional
  ...
  public JobDTO setJobname(String jobname) {
    this.jobname = jobname;
    return this;
  }
  ...
  public JobDTO setJobId(String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public JobDTO setStatus(String status) {
    this.status = status;
    return this;
  }
  ...
  public JobDTO setDeployStrategy(String deployStrategy) {
  ...
  public String getSubNameStrategy() {
    return this.subNameStrategy;
  }

  public JobDTO setSubNameStrategy(String subNameStrategy) {
  ...
  public JobDTO setConfig(String config) {
    this.config = config;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DEPLOY_STRATEGY:
      if (value == null) {
        ...
        setDeployStrategy((String)value);
      }
      break;
    ...
    case SUB_NAME_STRATEGY:
      if (value == null) {
        ...
        setSubNameStrategy((String)value);
      }
      break;
  ...
  public int compareTo(JobDTO other) {
    ...
    lastComparison = Boolean.valueOf(isSetDeployStrategy()).compareTo(other.isSetDeployStrategy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDeployStrategy()) {
    ...
    lastComparison = Boolean.valueOf(isSetSubNameStrategy()).compareTo(other.isSetSubNameStrategy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubNameStrategy()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("JobDTO(");
    boolean first = true;

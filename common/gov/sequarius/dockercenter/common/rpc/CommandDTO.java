...
public class CommandDTO implements org.apache.thrift.TBase<CommandDTO, CommandDTO._Fields>, java.io.Serializable, Cloneable, Comparable<CommandDTO> {
   ...
   * 命令
   */
  public CommandDTO setCommand(java.lang.String command) {
    this.command = command;
    return this;
  }
   ...
   * 参数
   */
  public CommandDTO setParams(java.util.List<java.lang.String> params) {
    this.params = params;
    return this;
  }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("CommandDTO(");
    boolean first = true;

...
class JobDTO(object):
    ...
    thrift_spec = (
        ...
        (4, TType.STRING, 'deployStrategy', 'UTF8', None, ),  # 4
        (5, TType.STRING, 'subNameStrategy', 'UTF8', None, ),  # 5
        (6, TType.STRING, 'config', 'UTF8', None, ),  # 6
    )

    def __init__(self, jobname=None, jobId=None, status=None, deployStrategy=None, subNameStrategy=None, config=None,):
        self.jobname = jobname
        self.jobId = jobId
        self.status = status
        self.deployStrategy = deployStrategy
        self.subNameStrategy = subNameStrategy
        self.config = config
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.deployStrategy = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.subNameStrategy = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if self.status is not None:
            ...
            oprot.writeFieldEnd()
        if self.deployStrategy is not None:
            oprot.writeFieldBegin('deployStrategy', TType.STRING, 4)
            oprot.writeString(self.deployStrategy.encode('utf-8') if sys.version_info[0] == 2 else self.deployStrategy)
            oprot.writeFieldEnd()
        if self.subNameStrategy is not None:
            oprot.writeFieldBegin('subNameStrategy', TType.STRING, 5)
            oprot.writeString(self.subNameStrategy.encode('utf-8') if sys.version_info[0] == 2 else self.subNameStrategy)
            oprot.writeFieldEnd()
        if self.config is not None:
            oprot.writeFieldBegin('config', TType.STRING, 6)
